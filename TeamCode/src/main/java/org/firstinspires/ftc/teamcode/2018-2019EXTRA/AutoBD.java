...
@Autonomous(name = "AUTOBD_TEST", group = "Template")
@Disabled
public class AutoBD extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
      ...
      //CODE TO GET ROBOT OFF LIFT AND IN FRONT OF STUFF  
       // setLiftPos(21000);
        ...
        GyroTurnSimple(0); //normalize angle
        TankForward(0.2,100); //Unlatch
        MeacanumStrafe(0.2,-100); //Strafe away from latch
        TankForward(0.2,-100); //Move to original pos.
        GyroTurnSimple(90); //Turn toward Minerals
        TankForward(0.2,-300); //Move closer to Minerals


      //MOVE BASED ON SAMPLE
        if (sampleLocation == "L") {
            GyroTurnSimple((90) + 35);
            TankForward(0.5, -1176);
            TankForward(0.5, 1176);
...
*/
    ...
    public void setLiftPos(int target){
        ...
        act.setMode(DcMotor.RunMode.RUN_USING_ENCODERS);
        act.setPower(0);
    }
